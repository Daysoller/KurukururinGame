...
const Menu = ({ onStart }) => {
  ...
  return (
    <div>
      ...
      >
        {/* Overlay oscuro para mejor legibilidad - Ajustado a 40% para mejor contraste con las letras nuevas */}
        ...
        <div className="relative z-20 flex flex-col items-center w-full max-w-4xl px-4">
          ...
          <div className="text-center mb-12 bg-black/30 backdrop-blur-sm p-6 rounded-2xl border border-white/10 shadow-xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-white to-blue-200 drop-shadow-lg tracking-wider mb-2">
              HOLA MALI
            </h1>
            <p className="text-blue-100 text-lg md:text-xl font-medium tracking-wide">
              ¿Lista para tu <span className="text-yellow-300 font-bold animate-pulse">sorpresa</span>?
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6 w-full max-w-sm">
            ...
            <button
              ...
              className="group relative w-full py-4 px-6 rounded-xl bg-gradient-to-r from-blue-950 to-blue-900 border-2 border-blue-800 shadow-[0_0_20px_rgba(30,58,138,0.5)] hover:shadow-[0_0_30px_rgba(30,58,138,0.8)] hover:scale-105 transition-all duration-300 ease-out overflow-hidden"
            >
            ...
            <button
              onClick={onStart}
              className="group relative w-full py-4 px-6 rounded-xl bg-gradient-to-r from-blue-900 to-blue-800 border-2 border-blue-700 shadow-[0_0_20px_rgba(29,78,216,0.5)] hover:shadow-[0_0_30px_rgba(29,78,216,0.8)] hover:scale-105 transition-all duration-300 ease-out overflow-hidden"
            >
              <div className="absolute inset-0 bg-white/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
